  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-gray-900 text-black dark:text-white py-16 px-4">
      <div className="max-w-[90%] mx-auto flex flex-col lg:flex-row items-center justify-center lg:gap-12">
        ...
        >
          <p className="italic text-gray-600 dark:text-gray-400 text-lg md:text-xl">
      ...
      <div className="relative z-10 w-full mt-12 text-center">
        ...
        >
          <div className="relative">
            ...
            <Link to="/volunteer">
              <motion.div
                className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-full px-4 py-2 flex items-center shadow-lg"
        ...
        >
          <motion.p className="text-lg dark:text-gray-300" variants={fadeIn}>
